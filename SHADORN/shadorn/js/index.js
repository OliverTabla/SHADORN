...
// Cambiar la posicion xy predeterminada del jugador
...
function animate(backgroundCanvas) {
  ...
  //Track distancia de scroll post
  if (player.x > SCROLL_POST_RIGHT && player.x < 1291) { //limite de la camara.x
    const scrollPostDistance = player.x - SCROLL_POST_RIGHT;
    camera.x = scrollPostDistance;
  }

  if (player.y < SCROLL_POST_TOP && camera.y > 0) { //limite de la camara.y arriba
